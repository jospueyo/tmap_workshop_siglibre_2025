...
También podem guardar la animación como un gif e insertarlo en cualquier lugar.

```{r}
#| eval: false

tmap_animation(evol_poblacion, delay = 100, "maps/evol_poblacion.gif", width = 800, height = 600)

```

![evol_poblacion]("docs/evol_poblacion.gif")